...
**3. 有备份,且演练过恢复。**
现状(2026-07-05):日 pg_dump 21:00+23:30 → 两地各 14 天 → 月度归档滚 12 份;exports/ 观测层
按日 blob 同链 tar(2026-07-05 起);使用者侧云盘日快照作保底。
**恢复演练至少每半年一次,挂季度全项目审视节拍(DECISIONS #33,首次 2026-10)。
首次演练 2026-07-05 已通过**:20260705 备份恢复临时库零错误,13 关键表行数逐一对齐,

...
导航 9 页:**报告**(大盘仪表→主线hero→三件事→证伪→盘中节奏→综述;右栏:资金面/隔夜美股/账本/事件流) / **研判**(仅A股:**B6节点研判**+**B8个股决策[校准横幅]**;右栏**B7成绩单**——判断层独立成页,报告页回归事实层,2026-07-05 使用者要求拆出) / **热点**(排名+X舆情+全量新闻流下钻) / **资金**(当日曲线|多日趋势) / **热力**(四象限+时间窗+下钻) / **研究** / **信函** / **问答**(自然语言问看板数据,SSE 流式,DECISIONS #38) / **系统**(health+信源面板)。顶部 A股|美股切换;任意股票可点开详情弹层(6M走势);手机 md: 断点适配。
